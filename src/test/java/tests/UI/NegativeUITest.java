...
public class NegativeUITest extends BaseTest {
    ...
    public void TC_NEG_01_CreateNoteEmptyTitle() {
        ...
        try {
            ...
            System.out.println(
                    "===== TC-NEG-01: Create Note with Empty Title =====");
            ...
            ScreenshotUtil.captureAndAttach(
                    driver,
                    "TC-NEG-01 Empty Title Validation");

            Assert.assertTrue(
                    validationShown,
                    "Validation not shown when note title is empty");
    ...
    public void TC_NEG_02_CreateNoteEmptyDescription() {
        ...
        try {
            ...
            System.out.println(
                    "===== TC-NEG-02: Create Note with Empty Description =====");
            ...
            ScreenshotUtil.captureAndAttach(
                    driver,
                    "TC-NEG-02 Empty Description Validation");

            Assert.assertTrue(
                    validationShown,
                    "Validation not shown when note description is empty");
